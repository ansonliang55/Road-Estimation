...
scipy.io.savemat(arguments.output_file, {'train_data':train_data, 'valid_data':valid_data, 'train_labels':train_labels, 'valid_labels':valid_labels, 'file_labels':file_labels, 'im_file_names':im_file_names, 'sp_file_names':sp_file_names, 'label_file_names':label_file_names,'valid_pixels_labels':valid_pixels_labels,'valid_files':valid_files,'valid_files_count':valid_files_count,'valid_superpixels':valid_superpixels,'train_superpixels':train_superpixels,'test_files_count':test_files_count,'validationOriginalImage':validationOriginalImage,'valid_edges':valid_edges,'train_edges':train_edges,'valid_edgesFeatures':valid_edgesFeatures,'train_edgesFeatures':train_edgesFeatures}, oned_as='column')